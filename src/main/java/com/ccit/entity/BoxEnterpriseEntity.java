...
@Entity
@Table(name = "box_enterprise", schema = "matrix", catalog = "")
public class BoxEnterpriseEntity {
    ...
    public BoxEnterpriseEntity(
        ...
        this(createUid, manufacturer, model, serialNumber, wanCount, hardwareVersion, softwareVersion, speedUp, speedDown,

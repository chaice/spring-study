package com.ccit.web.interceptor;
...
public class UserInterceptor extends HandlerInterceptorAdapter {
    ...
    private static ThreadLocal<SecurityUserEntity> localUser = new ThreadLocal<SecurityUserEntity>();

    private static ThreadLocal<CacheMode> localSecondLevelCache = new ThreadLocal<CacheMode>();

...
public class AccelerationBoxUpgradePackageVo {
    ...
    public AccelerationBoxUpgradePackageVo() {
    }

    public AccelerationBoxUpgradePackageVo(long id, String packageVersion, String suitableVersion, String fileName, Timestamp createTime) {
        this.id = id;

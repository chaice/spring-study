...
import com.ccit.rest.axis.response.AbstractAxisRes;
...
public abstract class AbstractAxisIF {

    // axis访问地址
    public static final String AXIS_ADDR = "axis.addr";
    ...
    @Autowired
    @Qualifier("axisOauthIF")
    private OauthIF oauthIF;

    protected String getPrefix() {
        return dictionaryService.fromKey(AXIS_ADDR);
    }

    protected <T extends AbstractAxisRes> T get(String uri, Object body, Class<? extends AbstractAxisRes> classOfT) {
    ...
    protected <T extends AbstractAxisRes> T post(String uri, Object body, Class<? extends AbstractAxisRes> classOfT) {
    ...
    protected <T extends AbstractAxisRes> T put(String uri, Object body, Class<? extends AbstractAxisRes> classOfT) {
        CommonRequest request = new CommonRequest(getPrefix(), appendToken(uri), gson.toJson(body), ContentType.APPLICATION_JSON);
    ...
    protected <T extends AbstractAxisRes> T patch(String uri, Object body, Class<? extends AbstractAxisRes> classOfT) {
        CommonRequest request = new CommonRequest(getPrefix(), appendToken(uri), gson.toJson(body), ContentType.APPLICATION_JSON);
    ...
    protected <T extends AbstractAxisRes> T delete(String uri, Class<? extends AbstractAxisRes> classOfT) {
        CommonRequest request = new CommonRequest(getPrefix(), appendToken(uri), null, ContentType.APPLICATION_JSON);
    ...
    private <T extends AbstractAxisRes> T getInstance(RestReturn restReturn, Class<? extends AbstractAxisRes> classOfT) {
        T instance = null;
